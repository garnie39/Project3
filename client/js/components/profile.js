    ...
    axios.get("/api/login").then((res) => {
      ...
      axios.get("/api/events").then((response) => {
        ...
        for (let e of showEvents) {
          ...
          const abc = document.getElementById(`${startDateToMatch}`);
          ...
          if (abc) {
            ...
            pEvent.addEventListener("click", () => {
              ...
              if (e.username == user && e.userJoin.length == 0) {
                ...
                <a id="editBtn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="editBtn" viewBox="0 0 16 16">
                ...
                <a id="deleteBtn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="deleteBtn" viewBox="0 0 16 16">
