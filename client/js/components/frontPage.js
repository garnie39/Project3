...
export function renderFrontPage() {
  ...
  name.innerText = "Catchy Calender";

  logo.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="200px" height="200px" fill="currentColor" class="logo" viewBox="0 0 16 16">
