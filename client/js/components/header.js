...
import { renderFriendsList } from "./friendsList.js";
...
function setHeaderHTML(name) {
  ...
  header.innerHTML = `
    <ul id="navList">
      ...
      <p id="space"></p>
      <li hidden><svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" fill="currentColor" id="notification" class="notification" viewBox="0 0 16 16">
      <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
    </svg></li>
      <li><svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" fill="currentColor" id="addFriends" class="addFriends" viewBox="0 0 16 16">
      <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
      <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
    </svg></li>
      <li><svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" fill="currentColor" id="logout" class="logout" viewBox="0 0 16 16">
...
function setSideBar() {
  ...
  sideBar.innerHTML = `
    <ul id="sideNavList">
      <li><svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="currentColor" id="friendsList" class="friendsList" viewBox="0 0 16 16">
      <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
    </svg></li>
      <li><svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="aliceblue" id="addEvents" class="addEvent" viewBox="0 0 16 16">
